...
<div class="gg-container">
    ...
    <div class="gg-404-container">
        ...
        <h1 class="gg-404-title">Â¡Ups! PÃ¡gina no encontrada</h1>

        <p class="gg-404-desc">
            La pÃ¡gina que estÃ¡s buscando no existe, ha sido movida o la direcciÃ³n ingresada no es correcta.
            Prueba realizando una bÃºsqueda a continuaciÃ³n o regresa a la pÃ¡gina de inicio.
        </p>

        <div class="gg-404-search">
            <form role="search" method="get" class="gg-search-form" action="<?php echo esc_url(home_url('/')); ?>">
                <input type="search" class="gg-search-input" style="width: 100%;" placeholder="Â¿QuÃ© estÃ¡s buscando?" value="<?php echo get_search_query(); ?>" name="s" />
